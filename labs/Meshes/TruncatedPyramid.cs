...
namespace labs.Meshes
{
    public class TruncatedPyramid : ModelVisual3D
    {
        ...
        private Point3D _size = new Point3D(0.5, 0.5, 0.5);
        public Point3D Size
        {
            get => _size;
            set
            ...
            Brush back)
        {
            ...
            double absX = size.X / 2;
            double absY = size.Y / 2;
            double absZ = size.Z / 2;


            Point3D front_left_bottom = new(-absX * 2 + pos.X, -absY  + pos.Y, absZ * 2 + pos.Z);
            Point3D front_right_bottom = new(absX * 2 + pos.X, -absY  + pos.Y, absZ * 2 + pos.Z);
            ...
            Point3D backside_left_bottom = new(-absX * 2 + pos.X, -absY + pos.Y, -absZ * 2 + pos.Z);
            Point3D backside_right_bottom = new(absX * 2 + pos.X, -absY + pos.Y, -absZ * 2 + pos.Z);
