...
{
    public class House3D : ModelVisual3D
    {
            ...
            Brush back)
        {
            ...
            Int32Collection indexes = new Int32Collection
            {
                0, 1, 2, 2, 4, 0,
            };
            ...
            ImageBrush doors = new ImageBrush();
            doors.ImageSource = new BitmapImage(new Uri("door.jpg", UriKind.Relative));
            ImageBrush floor = new ImageBrush();
            floor.ImageSource = new BitmapImage(new Uri("floor.jpg", UriKind.Relative));
            ImageBrush windows = new ImageBrush();
            windows.ImageSource = new BitmapImage(new Uri("window.jpg", UriKind.Relative));

            // 1 Передняя
            DiffuseMaterial material = new(doors);
